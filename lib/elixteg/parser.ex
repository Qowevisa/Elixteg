defmodule Elixteg.Parser do
  ...
  alias Elixteg.Model.{Video, Voice, Contact, Location, Venue, Update, File, CallbackQuery}
  alias Elixteg.Model.UserProfilePhotos
  alias Elixteg.Model.{Sticker, StickerSet}
