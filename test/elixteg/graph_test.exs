defmodule Elixteg.GraphTest do
  use ExUnit.Case
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney
  doctest Elixteg.Graph
  ...
  test "create_account" do
    use_cassette "graph/create_account" do
      {:ok, account} = Elixteg.Graph.create_account("some_short_name", "some_author_name")
  ...
  test "edit_account_info" do
    use_cassette "graph/edit_account_info" do
      {:ok, account} =
        Elixteg.Graph.edit_account_info(
  ...
  test "get_account_info" do
    use_cassette "graph/get_account_info" do
      {:ok, account} =
        Elixteg.Graph.get_account_info(
          "b968da509bb76866c35425099bc0989a5ec3b32997d55286c657e6994bbb",
  ...
  test "revoke_access_token" do
    use_cassette "graph/revoke_access_token" do
      {:ok, account} =
        Elixteg.Graph.revoke_access_token(
          "b968da509bb76866c35425099bc0989a5ec3b32997d55286c657e6994bbb"
        )
  ...
  test "get_page" do
    use_cassette "graph/get_page" do
      {:ok, page} = Elixteg.Graph.get_page("Sample-Page-12-15")
      assert page.title == "Sample Page"
  ...
  test "get_views" do
    use_cassette "graph/get_views" do
      {:ok, result} = Elixteg.Graph.get_views("Sample-Page-12-15", year: 2012, month: 12)
